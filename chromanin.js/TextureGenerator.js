...
{
	for (var v=0; v<this.layerSizeX*this.layerSizeY; v++)
		this.layers[dest][v].r=this.layers[src1][v].r ^ this.layers[src2][v].r;
		this.layers[dest][v].g=this.layers[src1][v].g ^ this.layers[src2][v].g;
		this.layers[dest][v].b=this.layers[src1][v].b ^ this.layers[src2][v].b;
}
